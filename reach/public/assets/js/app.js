...
var socketioUrl = "";
var socket = ""; // ***************** Update these Properties ***************** //
...
var app = new Vue({
  ...
  methods: {
    ...
    addClientAsOnline: function addClientAsOnline(cid) {
      if (!this.isClientOnline(cid)) {
        this.onlineClientIds.push({
          clientId: cid,
          willRemove: false
        });
        return;
      ...
      var ind = _.findIndex(this.onlineClientIds, function (c) {
    ...
    isClientOnline: function isClientOnline(cid) {
      return _.find(this.onlineClientIds, function (c) {
        return c.clientId == cid;
      }) != null;
    },
    ...
    getClients: function getClients() {
      var defaultId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      ...
      axios.get(api).then(function (response) {
        $.getJSON("/assets/js/flag.json", function (flags) {
          response.data.forEach(function (c) {
            ...
            c.missedCount = 0;
            c.flag = (_$find$emoji = (_$find = _.find(flags, function (f) {
              return f.keywords.indexOf(c.country.toLowerCase()) >= 0;
            })) === null || _$find === void 0 ? void 0 : _$find.emoji) !== null && _$find$emoji !== void 0 ? _$find$emoji : "🚩";
    ...
    viewClientInfo: function viewClientInfo(client) {
      this.viewClient = {
        ...
        source: client === null || client === void 0 ? void 0 : client.source,
        ...
        flag: client === null || client === void 0 ? void 0 : client.flag,
    ...
    endClientSession: function endClientSession(client) {
      ...
      if (confirm('Are you sure you want to end the session for this client?')) {
        ...
        axios.put(api, {
          ...
          _this.messages = [];
          _this.allMessages = _.filter(_this.allMessages, function (c) {
            return c.clientiD != client.clientId;
          });
    ...
    addClientToMultiWindow: function addClientToMultiWindow(client) {
      var index = _.findIndex(this.multiWindowList, function (w) {
        return w.clientId == client.clientId;
      });
      ...
      var entity = {
        windowId: "mw-".concat(client.clientId),
        label: "".concat(client.flag, "  ").concat(client.label ? client.label : client.clientId),
        clientId: client.clientId,
        body: '',
        messages: msgs
      };
    ...
    TimeTrigger: function TimeTrigger() {
      ...
      setInterval(function () {
        ...
        _this.onlineClientIds.forEach(function (c) {
          if (!c.willRemove) {
            c.willRemove = true;
          } else {
        ...
        cidToDelete.forEach(function (id) {
          var ind = _.findIndex(_this.onlineClientIds, function (c) {
